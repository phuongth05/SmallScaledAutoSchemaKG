...
Đoạn văn:
""",
    "event_relation": """Trích xuất quan hệ thời gian hoặc nhân quả giữa các sự kiện.
Mỗi sự kiện là một câu độc lập, cụ thể và có ý nghĩa. Các loại quan hệ gồm:
trước, sau, cùng thời điểm, bởi vì, và dẫn đến. Chỉ trích xuất quan hệ có căn cứ
trong văn bản; không dùng dấu ba chấm. Chỉ xuất mảng JSON theo mẫu:
